...
def generate_store_review(client, store: str, metrics: dict, manual: dict) -> dict:
    ...
    prompt = "\n".join([
        ...
        f"- Always use the store name '{store}' and manager names {sm} and {asm_str} by name",
        ...
        "- If labor is under 30%, call it out as a positive — the team is managing payroll well",
